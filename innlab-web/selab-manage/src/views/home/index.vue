  ...
  <AppPage show-footer>
    <div class="flex">
      <n-card class="min-w-200 w-30%">
        <div class="flex items-center">
          ...
          <div class="ml-20 flex-col">
            ...
            <span class="mt-4 opacity-50">当前角色：{{ userStore.currentRole}}</span>
          </div>
        </div>

        <p class="mt-28 text-14 opacity-60">通过科学研究和技术创新，培养创新人才，推动跨学科合作，解决现实问题，促进科技成果的转化和应用。</p>
        <p class="mt-12 text-right text-12 opacity-40">—— 创新实验室</p>
      </n-card>
      <n-card class="ml-12 w-70%" title="✨ 欢迎使用 Vue Naive Admin 2.0">
        ...
        <p class="opacity-60">
          创新实验室官网后台管理系统，前端使用 Vite + Vue3 + Pinia +
          Unocss，后端使用 Java +
          MySql，打造专属创新实验室网站后台管理系统！！！
        </p>
        <br>
        <br>
    ...
    <div class="mt-12 flex">
      <n-card class="w-50%" title="每日任务" segmented>
        <template #header-extra>
          <span class="opacity-90 text-highlight">👏 建立习惯和纪律，更好地追踪进度</span>
        </template>
      ...
      <n-card class="ml-12 w-50%" title="✨ 创新实验室部门成员分布" segmented>
  ...
  series: [
    {
      ...
      data: [
        { value: 38.5, name: '软件开发' },
        { value: 37.0, name: '网络安全' },
        { value: 6.5, name: '人工智能' },
        { value: 6.2, name: '虚拟现实' },
