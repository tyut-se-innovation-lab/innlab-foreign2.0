...
const actImgs = ref([
    ...
    "https://pic.2amok.com/20191019/a1992cb2011b3177c9f267c15aa19993_00003.jpg",
...
const prevSlide = () => {
    currentSlide.value = (currentSlide.value - 1 + actImgs.value.length) % actImgs.value.length;
};

const nextSlide = () => {
    currentSlide.value = (currentSlide.value + 1) % actImgs.value.length;
};
