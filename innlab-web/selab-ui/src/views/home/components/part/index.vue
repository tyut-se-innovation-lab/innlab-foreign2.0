        ...
        <div class="parts-bottom">
          ...
          <swiper id="swiper" :autoplay="{ delay: 6000 }" :loop="true" :navigation="true" :slidesPerView="3"
            ...
            <swiper-slide v-for="(slide, index) in slides" :key="index">
              <!-- 替换背景图片为 img 标签 -->
              <img
                  class="slide-bg-default"
                  src="https://picabstract-preview-ftn.weiyun.com/ftn_pic_abs_v3/73916b00cca62a232d41e1c8ce1c422edf017632266fc2280882e6a76e3351d94fb83b92a0d63a9b0c0b1f975892919f?pictype=scale&from=30013&version=3.3.3.3&fname=slide-bg-2.jpg&size=750"
                  referrerpolicy="no-referrer"
              />
              <img
                  class="slide-bg-active"
                  src="https://picabstract-preview-ftn.weiyun.com/ftn_pic_abs_v3/2fe498c0dbc6a57bc7e95bfcb2b113eb4c37bfc4c0de7ec9ac8a1354dfd0df798369e2375aee453f0da8dc987d0a373a?pictype=scale&from=30013&version=3.3.3.3&fname=slide-bg-6.png&size=750"
                  referrerpolicy="no-referrer"
              />
              <div class="slideItem">
...
/* 当 slide 激活时，切换背景图 */
:deep(.swiper-slide-active) .slide-bg-default {
  display: none;
}
:deep(.swiper-slide-active) .slide-bg-active {
  display: block;
}
...
.swiper-slide {
  ...
  transition: all .3s;
  /* 移除 background-image，已由 img 标签替代 */
}
