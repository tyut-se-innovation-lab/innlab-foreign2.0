<template>
  <div class="outer">
    ...
    <img
        ...
        src="https://picabstract-preview-ftn.weiyun.com/ftn_pic_abs_v3/218e0fb9ffff54547f62b13153c99abc4f36ee95ab29697d12dc78bfe38faa88f5e740f957cbef9707363b7ed826d05f?pictype=scale&from=30013&version=3.3.3.3&fname=bg5.jpg&size=750"
        alt=""
    />
    ...
    <div class="part">
      ...
      <div v-if="partName == '软件开发'" class="content">
        ...
        <div class="content-l">
          <h2>{{ partName }}</h2>
          <span>
                        软件开发作为创新实验室的一个部门，会不定期参与专业性比赛、接手实验室负责老师提供的实践项目等活动。对于刚进入开发小组的新生，主要以了解、学习专业知识为主。期间会有学长学姐们专门指导，规划学习路线，提供实战项目来巩固同学们的专业知识。随着学习的深入，按照学习情况与自身兴趣，会为同学们提供更加明确的学习方向，主要分为后端、前端、运维以及产品
                        4 个方向，在学习一段时间后会提供实际开发项目，以此来积累项目开发经验 、提升团队合作能力，实践项目也可列在简历中作为项目经历。</span>
...
let index = 0;
// 按钮点击样式切换逻辑保持不变（此处省略，实际代码中原有，此处保留）
// 以下为原样保留的按钮事件（由于未改动，省略具体代码）
...
const ActivitiesList = ref<Array<{ activityId: number; activityTitle: string; activityIntroduction: string; headerImage: string; createTime: string; author?: string }>>([]);
...
.bg-img {
  ...
  width: 100%;
  height: 100%;
  object-fit: cover; /* 等同于 background-size: cover */
  z-index: -1;       /* 放在内容之下 */
  pointer-events: none;
}
