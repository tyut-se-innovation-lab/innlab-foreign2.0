        ...
        <div class="part">
            ...
            <div v-if="partName == '软件开发'" class="content">
                ...
                <div class="content-l">
                    ...
                    <span>
                        软件开发作为创新实验室的一个部门，会不定期参与专业性比赛、接手实验室负责老师提供的实践项目等活动。对于刚进入开发小组的新生，主要以了解、学习专业知识为主。期间会有学长学姐们专门指导，规划学习路线，提供实战项目来巩固同学们的专业知识。随着学习的深入，按照学习情况与自身兴趣，会为同学们提供更加明确的学习方向，主要分为后端、前端、运维、算法以及产品
                        5 个方向，在学习一段时间后会提供实际开发项目，以此来积累项目开发经验 、提升团队合作能力，实践项目也可列在简历中作为项目经历。</span>
